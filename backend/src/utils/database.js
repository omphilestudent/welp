    ...
    try {
        const migrations = [
            ...
            `CREATE TABLE IF NOT EXISTS advertising_campaigns (
                ...
                status VARCHAR(32) DEFAULT 'pending_review' CHECK (status IN ('draft', 'pending_review', 'active', 'paused', 'completed', 'rejected', 'expired', 'removed')),
            ...
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS campaign_name VARCHAR(255);",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS ad_option VARCHAR(32) DEFAULT 'standard';",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS placement_type VARCHAR(32);",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS priority_level INT DEFAULT 1;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS priority_multiplier NUMERIC(6,2) DEFAULT 1.0;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS starts_at TIMESTAMPTZ;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS ends_at TIMESTAMPTZ;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS removed_at TIMESTAMPTZ;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS removed_by UUID REFERENCES users(id);",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS removal_reason TEXT;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS billing_cycle_anchor TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP;",
            "ALTER TABLE advertising_campaigns ADD COLUMN IF NOT EXISTS last_invoiced_at TIMESTAMPTZ;",
            ...
            "ALTER TABLE advertising_campaigns ADD CONSTRAINT advertising_campaigns_status_check CHECK (status IN ('draft','pending_review','active','paused','completed','rejected','expired','removed'));",
